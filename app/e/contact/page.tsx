...
export default function ContactPage() {
  ...
  return (
    <div className="max-w-sm mx-auto bg-white min-h-screen flex flex-col">
      ...
      {/* Form */}
      <form onSubmit={handleSubmit} className="flex-1 px-4 py-6 space-y-6 bg-gray-50 overflow-y-auto">
        {/* Title Field */}
            ...
            <div className="relative">
              ...
              <div className="flex items-center justify-center p-6 border-2 border-dashed border-gray-300 rounded-xl hover:border-orange-500 transition-colors">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">Click to upload a file or screenshot</p>
