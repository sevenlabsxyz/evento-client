      ...
      <div className='flex-1 overflow-y-auto'>
        {searchQuery ? (
                ...
                >
                  <img
                    ...
                    className={`object-cover ${
                      result.type === 'user' ? 'h-12 w-12 rounded-full' : 'h-12 w-12 rounded-lg'
                    }`}
                  />
          ...
          <div className='space-y-6 px-4 py-4'>
            {/* Recent Searches */}
            <div>
              <h3 className='mb-3 text-sm font-semibold text-gray-900'>Recent</h3>
            ...
            <div>
              ...
              <div className='flex flex-wrap gap-2'>
                {['#TokyoEvents', '#FoodFestival', '#Photography', '#Sunset', '#Travel'].map(
                  (tag, index) => (
                    <button
                      key={index}
