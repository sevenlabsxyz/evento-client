...
export default function MusicManagementPage() {
  ...
  React.useEffect(() => {
    if (existingEvent) {
      setMusicData({
        spotify: existingEvent.spotify_url
          ? { url: existingEvent.spotify_url }
          : undefined,
        wavlake: existingEvent.wavlake_url
          ? { url: existingEvent.wavlake_url }
          : undefined,
      });
    }
  }, [existingEvent]);
      ...
      <div className="space-y-6 p-4">
          ...
          <div className="mb-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Add a Spotify track or playlist
              </p>
            </div>
          </div>
        ...
        <div className="rounded-2xl bg-blue-50 p-4">
          <h4 className="mb-2 font-medium text-blue-900">
            About Music Integration
          </h4>
          <p className="text-sm text-blue-700">
            Music tracks you add here will be displayed on your event page,
            allowing guests to discover and listen to music related to your
            event.
          </p>
        </div>
      </div>
