...
export default function RegistrationQuestionsPage() {
  ...
  const handleEditQuestion = (questionId: string) => {
    ...
    if (question) {
      router.push(
        `/e/event/${eventId}/manage/registration/edit/${question.type}?id=${questionId}`,
      );
    }
  };
      ...
      <div className="p-4">
        {questions.length > 0 ? (
          <div className="space-y-3">
            <div className="mb-4 text-sm text-gray-500">
              Guests will be asked these questions when they register for your
              event.
            </div>
          ...
          <div className="py-16 text-center">
            ...
            <h3 className="mb-2 text-lg font-medium text-gray-900">
              No Registration Questions
            </h3>
            <p className="mb-6 text-sm text-gray-500">
              Add questions to collect information from guests when they
        ...
        <div className="mt-8 rounded-2xl bg-blue-50 p-4">
          ...
          <p className="text-sm text-blue-700">
            Use registration questions to collect specific information from your
            guests. You can make questions required or optional, and organize
            them in any order.
          </p>
        </div>
      </div>
