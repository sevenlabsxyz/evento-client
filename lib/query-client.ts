...
export const queryKeys = {
  ...
  eventsUser: (userId: string) =>
    [...queryKeys.events, "user", userId] as const,
  eventsUserMe: () => [...queryKeys.events, "user", "me"] as const,
  eventsUserGoing: (userId: string) =>
    [...queryKeys.events, "user", userId, "going"] as const,
  eventsUserPast: (userId: string) =>
    [...queryKeys.events, "user", userId, "past"] as const,

  // RSVPs
  rsvps: ["rsvps"] as const,
  eventRsvps: (eventId: string) =>
    [...queryKeys.rsvps, "event", eventId] as const,
  userRsvp: (eventId: string) => [...queryKeys.rsvps, "user", eventId] as const,

  // Comments
  comments: ["comments"] as const,
  eventComments: (eventId: string) =>
    [...queryKeys.comments, "event", eventId] as const,

  // Gallery
  gallery: ["gallery"] as const,
  eventGallery: (eventId: string) =>
    [...queryKeys.gallery, "event", eventId] as const,
