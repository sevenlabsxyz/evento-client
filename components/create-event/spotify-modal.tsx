...
export default function SpotifyModal({ isOpen, onClose, onSave }: SpotifyModalProps) {
    ...
    <div className='fixed inset-0 z-50 flex items-center justify-center'>
      ...
      <div className='relative mx-2 w-full rounded-3xl bg-white p-6 shadow-2xl md:mx-4 md:max-w-sm'>
        ...
        <div className='space-y-4'>
          <div>
            <label className='mb-2 block text-sm font-medium text-gray-700'>Spotify URL</label>
            <input
              type='url'
              value={url}
              onChange={(e) => {
