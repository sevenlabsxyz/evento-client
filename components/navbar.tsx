...
export function Navbar({ activeTab, onTabChange }: NavbarProps) {
  ...
  return (
    <div className="fixed bottom-0 pb-4 left-1/2 z-10 w-full max-w-full -translate-x-1/2 transform border-t border-gray-200 bg-white md:max-w-sm">
          ...
          if (item.isCenter) {
            return (
              <div className="flex justify-center">
                <div
                  key={item.id}
                  className="h-12 w-16 rounded-xl flex items-center justify-center bg-gray-200 hover:bg-gray-300 p-0 m-0 transition-colors duration-150"
