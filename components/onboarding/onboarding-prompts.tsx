              ...
              >
                <div className='mb-2 flex items-start justify-between'>
                  <div className='flex items-start gap-2'>
                    ...
                    <p className='flex-1 text-sm font-semibold text-gray-900'>{prompt.question}</p>
                  </div>
                ...
                {editingPromptId === prompt.prompt_id ? (
                  <div className='space-y-2'>
                    ...
                    <div className='flex items-center justify-between'>
                      <p className='text-xs text-gray-500'>{prompt.answer.length}/500 characters</p>
                  ...
                  >
                    ...
                    <div className='flex-1'>
                      ...
                      {prompt.placeholder_text && (
                        <p className='mt-0.5 text-xs text-gray-500'>{prompt.placeholder_text}</p>
                      )}
                    </div>
        ...
        {!canAddMore && (
          <div className='rounded-xl border border-yellow-200 bg-yellow-50 p-3'>
            <p className='text-sm text-yellow-800'>
              You&apos;ve reached the maximum of 4 prompts. Remove one to add a different prompt.
            </p>
          </div>
        )}
