...
export function BackupChoiceSheet({
  ...
  return (
    <SheetWithDetentFull.Root presented={open} onPresentedChange={handleOpenChange}>
      <SheetWithDetentFull.Portal>
        <SheetWithDetentFull.View>
          <SheetWithDetentFull.Backdrop />
          <SheetWithDetentFull.Content>
            <div className='mx-auto flex w-full items-center justify-center py-5 pt-3'>
              <SheetWithDetentFull.Handle className='mx-auto' />
            </div>
                  ...
                  {step === 'choice' && (
                    <div className='px-4 pb-8 pt-2'>
                      ...
                      <p className='mx-auto mt-6 max-w-sm text-center text-xs text-gray-400'>
                        Your backup is the only way to recover your funds if you lose access to this
                        device.
                        <br />
                        <br />
                        If you choose the recovery phrase option and lose it, you will lose access
                        to your funds.
                      </p>
                    </div>
                  )}
                    ...
                    <div className='space-y-6 px-4 pb-8'>
                      ...
                      <div className='space-y-4'>
                        ...
                        <div className='rounded-2xl border border-blue-300 bg-blue-50 p-4'>
                          <div className='flex items-start gap-2'>
                            ...
                            <div className='text-sm text-blue-900'>
                              ...
                              <p className='mt-1'>
                                If you lose your device, forget your PIN, or need to restore your
                                wallet on a new device, this encrypted backup is your only way to
                                recover your funds. Keep it safe!
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className='flex items-start gap-3 rounded-2xl border border-gray-200 bg-gray-50 p-4'>
                          ...
                          >
                            I have saved my encrypted backup to a secure location. I understand that
                            I will need both this backup AND my PIN to restore my wallet.
                          </Label>
                        </div>
                  ...
                  {step === 'seed-view' && (
                    <div className='space-y-6 px-4 pb-8'>
                      ...
                      <div className='rounded-2xl bg-red-50 p-4'>
                        <div className='flex gap-3'>
                          ...
                          <div className='text-sm text-red-900'>
                            ...
                            <p className='mt-1'>
                              Anyone with these words can access your wallet. Store them securely
                              offline.
                            </p>
                          </div>
                        </div>
                      ...
                      <div className='space-y-4'>
                        ...
                        <div
                          className={`rounded-2xl border-2 border-dashed p-4 ${showSeed ? '' : 'blur-sm'}`}
                        >
