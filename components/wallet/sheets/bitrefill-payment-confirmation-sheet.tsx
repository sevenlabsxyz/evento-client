    ...
    return (
      ...
      >
        ...
        <p className='mb-6 text-center text-sm text-gray-600'>
          We recommend backing up your wallet before making your first payment. If you lose access
          to your device, you&apos;ll need your backup to recover your funds.
        </p>
        ...
        <>
          ...
          <div className='mb-6 space-y-2 rounded-lg border border-gray-200 bg-white p-4'>
            <div className='flex justify-between text-sm'>
              ...
              <span className='font-medium'>{invoiceDetails.amountSats.toLocaleString()} sats</span>
            </div>
            <div className='flex justify-between text-sm'>
          ...
          {hasInsufficientBalance && (
            <div className='mb-4 flex items-start gap-2 rounded-lg border border-red-200 bg-red-50 p-3'>
              ...
              <p className='text-sm text-red-600'>
                Insufficient balance. You need {totalAmount.toLocaleString()} sats but only have{' '}
