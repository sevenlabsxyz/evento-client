                ...
                <SheetWithDetentFull.ScrollContent className="p-6">
                  ...
                  <div className="mb-6 space-y-3">
                    <p className="text-sm text-gray-500">
                      ...
                      used for the Nostr protocol. A Nostr identifier (NIP-05)
                      helps people find and verify your Nostr profile. It looks
                    ...
                    <div className="rounded-xl bg-pink-50 p-4">
                      ...
                      <p className="text-sm text-pink-700">
                        ...
                        across different Nostr apps. Nostr is a decentralized
                        social network protocol that gives you control over your
                        identity and content. Your NIP-05 identifier makes it
                        easy for others to find you across different Nostr apps.
                      </p>
                    </div>
                  </div>
