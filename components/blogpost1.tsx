      ...
      <div className='container'>
        <div className='prose mx-auto max-w-3xl dark:prose-invert'>
          ...
          <p className='mt-2 text-lg text-muted-foreground'>
            In a kingdom far away, where laughter once flowed freely, a peculiar tale unfolded about
            a king who decided to tax the very essence of joy itself - jokes and jest.
          </p>
