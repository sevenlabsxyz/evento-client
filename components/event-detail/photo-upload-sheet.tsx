        ...
        <SheetWithDetentFull.View>
          ...
          <SheetWithDetentFull.Content>
            <div className="flex flex-col h-full">
              ...
              <div className="relative flex-1 px-6 overflow-y-auto">
                ...
                {photos.length === 0 ? (
                  ...
                  <>
                    ...
                    {/* Photos grid */}
                    <div className="h-fit max-h-fit mb-52 grid grid-cols-3 gap-3 p-1 auto-rows-max">
                      {photos.map((photo) => (
                        <div key={photo.id} className="relative aspect-square">
                          ...
                          {uploading ? (
                            <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                              <div className="h-12 w-12 rounded-full border-4 border-white border-opacity-25 border-t-white animate-spin"></div>
                            ...
                            <button
                              ...
                              className="absolute top-1 right-1 rounded-full bg-black bg-opacity-70 p-1.5 text-white hover:bg-opacity-90"
                            >
              ...
              <div className="fixed bottom-0 left-0 right-0 p-6 border-t border-gray-100 bg-white flex flex-col gap-2">
                {photos.length > 0 && (
                  <Button
