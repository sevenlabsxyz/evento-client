...
- [x] 1. Remove noisy console logs in hooks (keep errors only)
  ...
  **Agent-Executed QA Scenarios**:
  ...
  Scenario: Verify no console.log in hooks
    Tool: Bash
    Steps:
      1. Run: `grep -r "console\.log" lib/hooks`
      2. Assert: no output
...
- [x] 2. Standardize integration tests on MSW handlers
  ...
  **Agent-Executed QA Scenarios**:
  ...
  Scenario: Run integration test suite with MSW
    Tool: Bash
    Steps:
      1. Run: `pnpm test --testPathPattern=__tests__/integration`
...
- [ ] 3. Add schema/DTO validation tests (type safety)
  ...
  **Agent-Executed QA Scenarios**:
  ...
  Scenario: Run schema tests only
    Tool: Bash
    Steps:
      1. Run: `pnpm test --testPathPattern=schema`
      2. Assert: exit code 0
...
- [ ] 4. Add high‑signal UI + auth/registration tests (fast)
  ...
  **Agent-Executed QA Scenarios**:
  ...
  Scenario: Run new UI/auth tests
    Tool: Bash
    Steps:
      1. Run: `pnpm test --testPathPattern=onboarding|registration|create-event`
      2. Assert: exit code 0
